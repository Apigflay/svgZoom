<template>
    <div class="enginManageWrap">
        <div class="mapArea" id="main" v-if="imgAreaShow==true">
            <!-- <div class="tipsArea">
        ...
        <div class="enginManage" v-if="imgAreaShow==false">
            <div class="main">
                <div class="projectArea">
                    <div class="treeArea">
                        <div class="title">供电单元选择</div>
                        <div class="tree">
                            <el-tree
                                style="width:260px"
                    ...
                    <div class="treeArea">
                        ...
                        <div class="btnArea">
                            <div class="sbtn"></div>
                            <button @click="goPages" class="nbtn">确定</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
  ...
  created() {
    //   console.log(this.$store.getters['AllallProcessId'])
      if(this.$store.getters['AllallProcessId']==7){
  ...
  methods: {
    ...
    goPages(){
        ...
        setTimeout(()=>{
            loading.close();
            this.imgAreaShow=true;
            this.$store.dispatch('SET_allProcessId',7);
